...
RUN wget https://github.com/mayswind/AriaNg/releases/download/${ARIANG_VARSION:-1.1.4}/AriaNg-${ARIANG_VARSION:-1.1.4}.zip \
    && unzip AriaNg-${ARIANG_VARSION:-1.1.4}.zip \
    && rm -f AriaNg-${ARIANG_VARSION:-1.1.4}.zip
